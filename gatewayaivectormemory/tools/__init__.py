TOOL_DEFINITIONS = [
    {
        "name": "remember",
        "description": "存入一条记忆。支持用户级（跨项目）、项目级和团队级存储，自动去重（相似度>0.95则更新）。",
        "inputSchema": {
            "type": "object",
            "properties": {
                "content": {"type": "string", "description": "记忆内容，Markdown 格式。命令类须含完整可执行命令，流程类须含具体步骤，禁止模糊缩写"},
                "tags": {"type": "array", "items": {"type": "string"}, "description": "标签列表"},
                "scope": {"type": "string", "enum": ["user", "project", "team"], "default": "project", "description": "作用域：user=跨项目个人记忆，project=项目内个人记忆，team=项目内团队共享记忆"}
            },
    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "scope": {"type": "string", "enum": ["user", "project", "team", "all"], "default": "all", "description": "作用域：user=跨项目个人记忆，project=项目内个人记忆，team=项目内团队共享记忆，all=全部"},
    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "scope": {"type": "string", "enum": ["user", "project", "team", "all"], "default": "all", "description": "配合 tags 使用，限定删除范围"}
            }
        }
    },
    {
...
from gatewayaivectormemory.tools.readme import handle_readme
